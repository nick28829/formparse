...
or Miniconda_::
    ...
    conda create -n formparse python=3 six virtualenv pytest pytest-cov
    conda activate formparse
...
#. Install |pre-commit|_::
   ...
   ``formparse`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/formparse
.. _issue tracker: https://github.com/<USERNAME>/formparse/issues
.. <-- end -->
